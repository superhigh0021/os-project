 ...
 * @param needdel
 */
 void cp_file(char *psrc, char *pdst, struct cp2mv_option *option,
                    int needdel) {
 ...
 * @param need_del
 */
 void cp_r(char *psrc, char *pdst, struct cp2mv_option *option,
                 int need_del) {
  size_t name_size;
  struct dirent *dirp;
  DIR *dp;
 ...
 * @param needdel 是否删除源
 */
 void cp(char *psrc, char *pdst, struct cp2mv_option *option,
               int needdel) {
  if (option->r) {
